      ...
      <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
        <section>
          ...
          <p className="text-foreground/80 leading-relaxed">
            ...
            définir les modalités et conditions d'utilisation de l'application mobile AceClub
            (ci-après "l'Application") ainsi que de définir les droits et obligations des parties
            dans ce cadre.
          </p>
          <p className="text-foreground/80 leading-relaxed mt-4">
            L'Application est éditée par AceClub SAS, société par actions simplifiée au capital de
            [montant] euros, immatriculée au RCS de Paris sous le numéro [numéro], dont le siège
        ...
        <section>
          ...
          <p className="text-foreground/80 leading-relaxed mt-4">
            AceClub se réserve le droit de modifier à tout moment les présentes CGU. Les
        ...
        <section>
          ...
          <p className="text-foreground/80 leading-relaxed">
            AceClub est une application mobile permettant aux membres de clubs de tennis et de padel
            de :
          </p>
        ...
        <section>
          ...
          <p className="text-foreground/80 leading-relaxed mt-4">
            L'utilisateur s'engage à ne pas créer de compte au nom d'une autre personne et à ne pas
        ...
        <section>
          ...
          <p className="text-foreground/80 leading-relaxed mt-4">
            AceClub ne saurait être tenue responsable des dommages directs ou indirects résultant de
        ...
        <section>
          ...
          <p className="text-foreground/80 leading-relaxed">
            ...
            l'Application. AceClub se réserve le droit de suspendre ou de supprimer un compte en cas
