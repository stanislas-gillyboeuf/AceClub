...
export default function PrivacyPage() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <p className="text-muted-foreground mb-8">Dernière mise à jour : 4 février 2026</p>
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-4 space-y-2 text-foreground/80">
            <li>
              <strong>Gestion de votre compte :</strong> création, authentification et gestion de
              votre profil utilisateur
            </li>
            <li>
              <strong>Mise en relation :</strong> permettre la recherche de partenaires et
              l'organisation de matchs
            </li>
            <li>
              <strong>Communication :</strong> faciliter les échanges entre utilisateurs via la
              messagerie
            </li>
            <li>
              <strong>Gamification :</strong> gestion des défis, des récompenses et des classements
            </li>
            <li>
              <strong>Amélioration du service :</strong> analyse de l'utilisation pour améliorer
              l'Application
            </li>
            <li>
              <strong>Support client :</strong> répondre à vos questions et demandes
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-4 space-y-2 text-foreground/80">
            <li>
              <strong>L'exécution du contrat :</strong> pour fournir les services de l'Application
            </li>
            <li>
              <strong>Votre consentement :</strong> pour certaines fonctionnalités optionnelles
            </li>
            <li>
              <strong>Notre intérêt légitime :</strong> pour améliorer nos services et assurer la
              sécurité
            </li>
            <li>
              <strong>Nos obligations légales :</strong> pour respecter la réglementation applicable
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-4 space-y-2 text-foreground/80">
            <li>
              Les autres utilisateurs de l'Application (dans la limite des informations de votre
              profil public)
            </li>
        ...
        <section>
          ...
          <p className="text-foreground/80 leading-relaxed">
            Vos données sont conservées pendant la durée de votre utilisation de l'Application, puis
            archivées pendant une durée de 3 ans après la suppression de votre compte, conformément
            aux délais de prescription légaux.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-foreground/80 leading-relaxed">
            Nous pouvons modifier cette politique de confidentialité à tout moment. Toute
            modification substantielle vous sera notifiée via l'Application. La date de dernière
